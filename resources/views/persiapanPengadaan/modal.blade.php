...
<div class="modal fade" id="modal-pelaksana-kegiatan">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>100</td>
                                    <td>Kg</td>
                                    <td><textarea type="text" class="form-control" placeholder="Catatan Perubahan"></textarea></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>PR-1234</td>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="spesifikasi">
                                <tr>
                                    ...
                                    <td>
                                        <button id="tambah-baris" type="button" onclick="tambahBarisSpesifikasi()" class="btn btn-primary btn-xs">
